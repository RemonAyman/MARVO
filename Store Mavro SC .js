const products = {
    tshirts: [
        ...
        { id: 3, name: 'Third Kit:', price: 450, img: 'WhatsApp Image 2024-12-27 at 03.44.39_4237d596.jpg' },
...
// Function to add predefined product to the cart
    ...
    cart.forEach((item, index) => {
        ...
        let itemDetails = `
            <p>
                ...
                ${item.material ? `<br><small>Material: ${item.material}, Size: ${item.size}, Text: ${item.text}, Number: ${item.number}</small>` : ''}
                <button class="text-red-600 ml-2" onclick="removeFromCart(${index})">Remove</button>
            </p>
        `;
...
function cancelPurchase() {
    ...
    window.location.href = 'index.html'; // Replace with your store's main page
}
